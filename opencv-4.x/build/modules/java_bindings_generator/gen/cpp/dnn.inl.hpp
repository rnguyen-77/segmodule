...
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/dnn/include/opencv2/dnn/dict.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/dnn/include/opencv2/dnn/dnn.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/dnn/include/opencv2/dnn/utils/inference_engine.hpp"
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_forwardAndRetrieve_10 (JNIEnv*, jclass, jlong, jlong, jobject);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_forwardAndRetrieve_10
  (JNIEnv* env, jclass , jlong self, jlong outputBlobs_mat_nativeObj, jobject outBlobNames_list)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::forwardAndRetrieve_10()";
    try {
        LOGD("%s", method_name);
        ...
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->forward( outputBlobs, outBlobNames );
        vector_vector_Mat_to_Mat( outputBlobs, outputBlobs_mat );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayersShapes_10 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayersShapes_10
  (JNIEnv* env, jclass , jlong self, jlong netInputShapes_mat_nativeObj, jlong layersIds_mat_nativeObj, jlong inLayersShapes_mat_nativeObj, jlong outLayersShapes_mat_nativeObj)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::getLayersShapes_10()";
    try {
        LOGD("%s", method_name);
        std::vector< MatShape > netInputShapes;
        Mat& netInputShapes_mat = *((Mat*)netInputShapes_mat_nativeObj);
        Mat_to_vector_MatShape( netInputShapes_mat, netInputShapes );
        std::vector<int> layersIds;
        Mat& layersIds_mat = *((Mat*)layersIds_mat_nativeObj);
        std::vector< std::vector<MatShape> > inLayersShapes;
        Mat& inLayersShapes_mat = *((Mat*)inLayersShapes_mat_nativeObj);
        std::vector< std::vector<MatShape> > outLayersShapes;
        Mat& outLayersShapes_mat = *((Mat*)outLayersShapes_mat_nativeObj);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getLayersShapes( netInputShapes, layersIds, inLayersShapes, outLayersShapes );
        vector_int_to_Mat( layersIds, layersIds_mat );
        vector_vector_MatShape_to_Mat( inLayersShapes, inLayersShapes_mat );
        vector_vector_MatShape_to_Mat( outLayersShapes, outLayersShapes_mat );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayersShapes_11 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getLayersShapes_11
  (JNIEnv* env, jclass , jlong self, jlong netInputShape_mat_nativeObj, jlong layersIds_mat_nativeObj, jlong inLayersShapes_mat_nativeObj, jlong outLayersShapes_mat_nativeObj)
{
    using namespace cv::dnn;
    static const char method_name[] = "dnn::getLayersShapes_11()";
    try {
        LOGD("%s", method_name);
        ...
        Mat& outLayersShapes_mat = *((Mat*)outLayersShapes_mat_nativeObj);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        me->getLayersShapes( netInputShape, layersIds, inLayersShapes, outLayersShapes );
        vector_int_to_Mat( layersIds, layersIds_mat );
        vector_vector_MatShape_to_Mat( inLayersShapes, inLayersShapes_mat );
        vector_vector_MatShape_to_Mat( outLayersShapes, outLayersShapes_mat );
    } catch(const std::exception &e) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Net_getFLOPS_10
  (JNIEnv* env, jclass , jlong self, jlong netInputShapes_mat_nativeObj)
{
    using namespace cv::dnn;
...
JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Net_getFLOPS_12 (JNIEnv*, jclass, jlong, jint, jlong);

JNIEXPORT jlong JNICALL Java_org_opencv_dnn_Net_getFLOPS_12
  (JNIEnv* env, jclass , jlong self, jint layerId, jlong netInputShapes_mat_nativeObj)
{
    using namespace cv::dnn;
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Net_getMemoryConsumption_11
  (JNIEnv* env, jclass , jlong self, jint layerId, jlong netInputShapes_mat_nativeObj, jdoubleArray weights_out, jdoubleArray blobs_out)
{
    using namespace cv::dnn;
