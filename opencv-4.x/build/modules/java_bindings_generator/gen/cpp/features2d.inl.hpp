...
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/features2d/misc/java/src/cpp/features2d_converters.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/features2d/include/opencv2/features2d.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_features2d_GFTTDetector_create_17
  (JNIEnv* env, jclass , jint maxCorners, jdouble qualityLevel, jdouble minDistance, jint blockSize, jint gradientSize, jboolean useHarrisDetector, jdouble k)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::GFTTDetector> Ptr_GFTTDetector;
        Ptr_GFTTDetector _retval_ = cv::GFTTDetector::create( (int)maxCorners, (double)qualityLevel, (double)minDistance, (int)blockSize, (int)gradientSize, (bool)useHarrisDetector, (double)k );
        return (jlong)(new Ptr_GFTTDetector(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_features2d_GFTTDetector_create_18
  (JNIEnv* env, jclass , jint maxCorners, jdouble qualityLevel, jdouble minDistance, jint blockSize, jint gradientSize, jboolean useHarrisDetector)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::GFTTDetector> Ptr_GFTTDetector;
        Ptr_GFTTDetector _retval_ = cv::GFTTDetector::create( (int)maxCorners, (double)qualityLevel, (double)minDistance, (int)blockSize, (int)gradientSize, (bool)useHarrisDetector );
        return (jlong)(new Ptr_GFTTDetector(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_features2d_GFTTDetector_create_19
  (JNIEnv* env, jclass , jint maxCorners, jdouble qualityLevel, jdouble minDistance, jint blockSize, jint gradientSize)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::GFTTDetector> Ptr_GFTTDetector;
        Ptr_GFTTDetector _retval_ = cv::GFTTDetector::create( (int)maxCorners, (double)qualityLevel, (double)minDistance, (int)blockSize, (int)gradientSize );
        return (jlong)(new Ptr_GFTTDetector(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
