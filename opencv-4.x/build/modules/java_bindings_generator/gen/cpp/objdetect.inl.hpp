...
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/misc/java/src/cpp/objdetect_converters.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/aruco_board.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/aruco_detector.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/aruco_dictionary.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/barcode.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/charuco_detector.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/detection_based_tracker.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/face.hpp"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/objdetect/include/opencv2/objdetect/graphical_code_detector.hpp"
...
JNIEXPORT void JNICALL Java_org_opencv_objdetect_ArucoDetector_detectMarkersWithConfidence_10 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_objdetect_ArucoDetector_detectMarkersWithConfidence_10
  (JNIEnv* env, jclass , jlong self, jlong image_nativeObj, jlong corners_mat_nativeObj, jlong ids_nativeObj, jlong markersConfidence_nativeObj, jlong rejectedImgPoints_mat_nativeObj)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::detectMarkersWithConfidence_10()";
    try {
        LOGD("%s", method_name);
        std::vector<Mat> corners;
        Mat& corners_mat = *((Mat*)corners_mat_nativeObj);
        ...
        Mat& image = *((Mat*)image_nativeObj);
        Mat& ids = *((Mat*)ids_nativeObj);
        Mat& markersConfidence = *((Mat*)markersConfidence_nativeObj);
        (*me)->detectMarkersWithConfidence( image, corners, ids, markersConfidence, rejectedImgPoints );
        vector_Mat_to_Mat( corners, corners_mat );
        vector_Mat_to_Mat( rejectedImgPoints, rejectedImgPoints_mat );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_objdetect_ArucoDetector_detectMarkersWithConfidence_11 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jlong);

JNIEXPORT void JNICALL Java_org_opencv_objdetect_ArucoDetector_detectMarkersWithConfidence_11
  (JNIEnv* env, jclass , jlong self, jlong image_nativeObj, jlong corners_mat_nativeObj, jlong ids_nativeObj, jlong markersConfidence_nativeObj)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::detectMarkersWithConfidence_11()";
    try {
        LOGD("%s", method_name);
        std::vector<Mat> corners;
        Mat& corners_mat = *((Mat*)corners_mat_nativeObj);
        ...
        Mat& ids = *((Mat*)ids_nativeObj);
        Mat& markersConfidence = *((Mat*)markersConfidence_nativeObj);
        (*me)->detectMarkersWithConfidence( image, corners, ids, markersConfidence );
        vector_Mat_to_Mat( corners, corners_mat );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
// float DetectorParameters::validBitIdThreshold
//

JNIEXPORT jfloat JNICALL Java_org_opencv_objdetect_DetectorParameters_get_1validBitIdThreshold_10 (JNIEnv*, jclass, jlong);

JNIEXPORT jfloat JNICALL Java_org_opencv_objdetect_DetectorParameters_get_1validBitIdThreshold_10
  (JNIEnv* env, jclass , jlong self)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::get_1validBitIdThreshold_10()";
    try {
        LOGD("%s", method_name);
        cv::aruco::DetectorParameters* me = (cv::aruco::DetectorParameters*) self; //TODO: check for NULL
        return me->validBitIdThreshold;//();
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
//
// void DetectorParameters::validBitIdThreshold
//

JNIEXPORT void JNICALL Java_org_opencv_objdetect_DetectorParameters_set_1validBitIdThreshold_10 (JNIEnv*, jclass, jlong, jfloat);

JNIEXPORT void JNICALL Java_org_opencv_objdetect_DetectorParameters_set_1validBitIdThreshold_10
  (JNIEnv* env, jclass , jlong self, jfloat validBitIdThreshold)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::set_1validBitIdThreshold_10()";
    try {
        LOGD("%s", method_name);
        cv::aruco::DetectorParameters* me = (cv::aruco::DetectorParameters*) self; //TODO: check for NULL
        me->validBitIdThreshold = ( (float)validBitIdThreshold );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT jboolean JNICALL Java_org_opencv_objdetect_Dictionary_identify_11 (JNIEnv*, jclass, jlong, jlong, jdoubleArray, jdoubleArray, jdouble, jfloat);

JNIEXPORT jboolean JNICALL Java_org_opencv_objdetect_Dictionary_identify_11
  (JNIEnv* env, jclass , jlong self, jlong onlyCellPixelRatio_nativeObj, jdoubleArray idx_out, jdoubleArray rotation_out, jdouble maxCorrectionRate, jfloat validBitIdThreshold)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::identify_11()";
    try {
        LOGD("%s", method_name);
        cv::aruco::Dictionary* me = (cv::aruco::Dictionary*) self; //TODO: check for NULL
        Mat& onlyCellPixelRatio = *((Mat*)onlyCellPixelRatio_nativeObj);
        int idx;
        int rotation;
        bool _retval_ = me->identify( onlyCellPixelRatio, idx, rotation, (double)maxCorrectionRate, (float)validBitIdThreshold );
        jdouble tmp_idx[1] = {(jdouble)idx}; env->SetDoubleArrayRegion(idx_out, 0, 1, tmp_idx);
        jdouble tmp_rotation[1] = {(jdouble)rotation}; env->SetDoubleArrayRegion(rotation_out, 0, 1, tmp_rotation);
        return _retval_;
    } catch(const std::exception &e) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getBitsFromByteList_10 (JNIEnv*, jclass, jlong, jint, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getBitsFromByteList_10
  (JNIEnv* env, jclass , jlong byteList_nativeObj, jint markerSize, jint rotationId)
{
    using namespace cv::aruco;
    ...
    try {
        ...
        cv::Mat _retval_ = cv::aruco::Dictionary::getBitsFromByteList( byteList, (int)markerSize, (int)rotationId );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getBitsFromByteList_11 (JNIEnv*, jclass, jlong, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getBitsFromByteList_11
  (JNIEnv* env, jclass , jlong byteList_nativeObj, jint markerSize)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::getBitsFromByteList_11()";
    try {
        LOGD("%s", method_name);
        Mat& byteList = *((Mat*)byteList_nativeObj);
...
JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getMarkerBits_10 (JNIEnv*, jclass, jlong, jint, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getMarkerBits_10
  (JNIEnv* env, jclass , jlong self, jint markerId, jint rotationId)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::getMarkerBits_10()";
    try {
        LOGD("%s", method_name);
        cv::aruco::Dictionary* me = (cv::aruco::Dictionary*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getMarkerBits( (int)markerId, (int)rotationId );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getMarkerBits_11 (JNIEnv*, jclass, jlong, jint);

JNIEXPORT jlong JNICALL Java_org_opencv_objdetect_Dictionary_getMarkerBits_11
  (JNIEnv* env, jclass , jlong self, jint markerId)
{
    using namespace cv::aruco;
    static const char method_name[] = "objdetect::getMarkerBits_11()";
    try {
        LOGD("%s", method_name);
        cv::aruco::Dictionary* me = (cv::aruco::Dictionary*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getMarkerBits( (int)markerId );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
