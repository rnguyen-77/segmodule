...
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/calib3d/include/opencv2/calib3d/calib3d_c.h"
#include "/mnt/netapp/SECURITY/users/rnguyen/segModule/opencv-4.x/modules/calib3d/include/opencv2/calib3d.hpp"
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_10 (JNIEnv*, jclass, jlong, jlong, jlong, jint, jdouble, jlong, jdouble, jlong);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_10
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj, jint method, jdouble ransacReprojThreshold, jlong maxIters, jdouble confidence, jlong refineIters)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_10()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers, (int)method, (double)ransacReprojThreshold, (size_t)maxIters, (double)confidence, (size_t)refineIters );
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_11 (JNIEnv*, jclass, jlong, jlong, jlong, jint, jdouble, jlong, jdouble);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_11
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj, jint method, jdouble ransacReprojThreshold, jlong maxIters, jdouble confidence)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_11()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers, (int)method, (double)ransacReprojThreshold, (size_t)maxIters, (double)confidence );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_12 (JNIEnv*, jclass, jlong, jlong, jlong, jint, jdouble, jlong);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_12
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj, jint method, jdouble ransacReprojThreshold, jlong maxIters)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_12()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers, (int)method, (double)ransacReprojThreshold, (size_t)maxIters );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_13 (JNIEnv*, jclass, jlong, jlong, jlong, jint, jdouble);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_13
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj, jint method, jdouble ransacReprojThreshold)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_13()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers, (int)method, (double)ransacReprojThreshold );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_14 (JNIEnv*, jclass, jlong, jlong, jlong, jint);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_14
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj, jint method)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_14()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers, (int)method );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_15 (JNIEnv*, jclass, jlong, jlong, jlong);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_15
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj, jlong inliers_nativeObj)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_15()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Mat& inliers = *((Mat*)inliers_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to, inliers );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
...
JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_16 (JNIEnv*, jclass, jlong, jlong);

JNIEXPORT jdoubleArray JNICALL Java_org_opencv_calib3d_Calib3d_estimateTranslation2D_16
  (JNIEnv* env, jclass , jlong from_nativeObj, jlong to_nativeObj)
{
    
    static const char method_name[] = "calib3d::estimateTranslation2D_16()";
    try {
        LOGD("%s", method_name);
        Mat& from = *((Mat*)from_nativeObj);
        Mat& to = *((Mat*)to_nativeObj);
        Vec2d _retval_ = cv::estimateTranslation2D( from, to );
        jdoubleArray _da_retval_ = env->NewDoubleArray(2);  jdouble _tmp_retval_[2] = {(jdouble)_retval_.val[0], (jdouble)_retval_.val[1]}; env->SetDoubleArrayRegion(_da_retval_, 0, 2, _tmp_retval_);
        return _da_retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
